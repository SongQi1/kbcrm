...
/**
 * Description:<p> </p>
 * Created by songqi on 2017/8/4.
 */
@Configuration
@MapperScan("com.bocs.sys.mapper*")
public class MyBatisPlusConfig {
    @Autowired
    private ChooseDataSource dataSource;
     ...
     */
    @Bean
    public MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean(GlobalConfiguration globalConfig) {
