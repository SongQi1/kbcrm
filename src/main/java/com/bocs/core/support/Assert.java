...
import com.bocs.core.util.IDCardUtil;
...
public abstract class Assert {
	...
	public static void textLength(String text,int length,String key){
		if(text == null || length(text) > length){
			throw new IllegalArgumentException(getMessage(key+"_TOO_LONG"));
		}
	}
